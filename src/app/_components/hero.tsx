...
import { ArrowBigRightDashIcon, ArrowRightCircle } from "lucide-react"
...
const Hero = () => {
  return (
    <section>
      <div className="container grid grid-cols-1 lg:grid-cols-2 my-5">
        <div className="py-10">
          <h1 className="font-semibold text-3xl">Slice into Happiness</h1>
          <p className="font-semibold mt-3">Craving Pizza? we've got you covered with fresh ingredient, endless flavors, and the fastes delivery, your prefct slice is just a tap away!</p>
