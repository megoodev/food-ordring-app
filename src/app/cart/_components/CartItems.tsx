...
const CartItems = ({ items }: { items: CartItem[] }) => {
  ...
  return (
    ...
    <div className="flex flex-col gap-6">
      {items.map((item) => (
        <div key={item.id} className="bg-white rounded-xl shadow-md border border-gray-100 p-4 flex flex-col sm:flex-row items-center gap-4 hover:shadow-lg transition-shadow">
